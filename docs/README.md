...
| [v5r_記錄_近重複影像跨split洩漏查驗.md](v5r_記錄_近重複影像跨split洩漏查驗.md) | Scale_Insect / Thrips / Aphid 的洩漏查驗、量化、修正設計；**§8：v5.5 已建置**，Scale_Insect/Canker 洩漏清零，Thrips/Aphid 殘留未修 | 評估 test 集數字可信度、要動 v5.5 之前 |
