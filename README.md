...
**下一步是人工工作包 A**（`Thrips_Damage` 的雙人一致性測試）。
它是唯一剩下的顯著 valid/test 矛盾，而且三輪都沒有隨評估集擴大而收斂
...
| **最新一輪的訓練結果** | [v11.5_結果_評估精度驗證.md](docs/v11.5_結果_評估精度驗證.md) |
| 要對外簡報 | [v11.5_報告_階段性進度週報.md](docs/v11.5_報告_階段性進度週報.md) |
